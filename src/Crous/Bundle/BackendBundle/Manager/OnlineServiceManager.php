 ...
 * ServiceManager
 */
class OnlineServiceManager extends BaseManager
{
    protected $_entityName = 'OnlineService';
    ...
    {
        return $this->getRepository()->getOnlineServices($this->_filter($criteria), $order, $limit, $offset);
    }
