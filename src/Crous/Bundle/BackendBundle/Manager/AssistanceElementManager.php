...
/**
 * AssistanceElementManager
 */
class AssistanceElementManager extends BaseManager
{
    protected $_entityName = 'AssistanceElement';
    ...
    {
        return $this->getRepository()->getAssistanceElements($this->_filter($criteria), $order, $limit, $offset);
    }
