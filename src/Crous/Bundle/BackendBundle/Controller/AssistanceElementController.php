...
/**
 * AssistanceElementController
 */
class AssistanceElementController extends Controller
{
    protected $_ctrKey = 'assistanceElement';
    ...
    public function deleteAction(Request $request, $id)
    {
        if (!is_null($id)) {
            $entity = $this->get('entity_factory')->get($this->_ctrKey, $id);
            $pid = $entity->getAssistance()->getId();
            if (is_null($entity)) {
                throw $this->createNotFoundException();
            }
        ...
        $listRoute = 'crous_backend_assistance_add';
