...
use Crous\Bundle\BackendBundle\Form\Event\ScholarshipElementSubscriber;

/**
 * ScholarshipElementType
 *
 */
class ScholarshipElementType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->addEventSubscriber(new ScholarshipElementSubscriber($this->_container));
    }
