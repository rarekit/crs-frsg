...
/**
 * AssistanceElementSubscriber
 *
 */
class AssistanceElementSubscriber implements EventSubscriberInterface
{
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        $this->_imagePath = "/upload/assistance_elements/";
    }
    ...
    public function postBind(FormEvent $event)
    {
        ...
        if ($pid != NULL) {
            $assistance = $this->_container->get('entity_factory')->get('assistance', $pid);
            $data->setAssistance($assistance);
        }
